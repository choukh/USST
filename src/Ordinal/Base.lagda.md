...
```agda
infixr 2 step-≃ₒ step-≃ₒ˘ _≃ₒ⟨⟩_
infix  3 _≃ₒ∎

step-≃ₒ : (α : Ord 𝓊) {β : Ord 𝓋} {γ : Ord 𝓌} → β ≃ₒ γ → α ≃ₒ β → α ≃ₒ γ
step-≃ₒ _ = flip ≃ₒ-trans

syntax step-≃ₒ A B p = A ≃ₒ⟨ p ⟩ B

step-≃ₒ˘ : (α : Ord 𝓊) {β : Ord 𝓋} {γ : Ord 𝓌} → β ≃ₒ γ → β ≃ₒ α → α ≃ₒ γ
step-≃ₒ˘ _ = flip (≃ₒ-trans ∘ ≃ₒ-sym)
